...
//This is sort of the default operation needed for all files
const basePathInfo = {
  fn: async (object) => {
...
const arrayOfOperations = [basePathInfo, ...crawlOperations]
...
const getAllFilesInformation = async (files) => {
  ...
  for await (const file of files) {
    const fileObject = await returnOneObject(file)
